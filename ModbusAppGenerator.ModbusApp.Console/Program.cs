...
namespace ModbusAppGenerator.ModbusApp.ConsoleApp
{
    class Program
    {
            ...
            using (var scope = container.BeginLifetimeScope())
            {
                ...
                try
                {
                    ...
                    if (masterSettings.Period > 0)
                    {
                        ...
                        var timer = new System.Timers.Timer(masterSettings.Period * 1000);
                        ...
                        {
                            var packagesLogTimer = new System.Timers.Timer(masterSettings.StatFlushPeriod * 1000 * 60);
